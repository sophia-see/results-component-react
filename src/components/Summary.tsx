...
export default function Summary () {
    return (
        <div className="flex flex-col gap-6 px-[32px] py-[24px] flex-1 md:gap-7 md:py-[38px]">
            {/* summary title */}
            <div className="font-bold text-[18px] text-navyblue">Summary</div>
            {/* summary cards */}
                    ...
                    return (
                        <div className={`flex justify-between rounded-[12px] ${bgColor} py-[17px] px-[16px]`}>
                            <div className="flex gap-3">
                                ...
                                <div className={`${textColor}`}>{category.category}</div>
                            </div>
                            <div className="flex gap-2">
                                <div className="font-bold text-[16px] text-navyblue">{category.score}</div>
                                <div className="font-bold text-[16px] text-navyblue opacity-50">/ 100</div>
                            </div>
                        </div>
                    )
                })}
